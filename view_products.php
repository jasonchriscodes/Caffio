        ...
        <section class="products">
            <div class="box-container">
                ...
                <form action="" method="post" class="box">
                    <img src="img/<?= $fetch_products['image']; ?>" alt="<?= $fetch_products['name']; ?>" class="img">

                    <div class="button">
                        <!-- View button - Top Left -->
                        <a href="view_page.php?pid=<?php echo $fetch_products['product_id']; ?>"
                            class="bx bxs-show"></a>
                    ...
                    <div class="flex">
                        <p class="price">price NZD $<?= $fetch_products['price']; ?></p>
