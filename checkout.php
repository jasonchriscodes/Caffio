    ...
    <div class="main">
        ...
        <section class="checkout">
            <div class="title">
                ...
                <h1>Checkout Summary</h1>
                <p>Review your checkout summary, including item totals, shipping costs, and estimated delivery. Complete
                    your purchase and enjoy your green coffee!
                </p>
            </div>
            <div class="row">
                    ...
                    <div class="flex">
                        ...
                        <div class="box">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="pincode" required maxlength="6" placeholder="390012" min="0"
                ...
                <div class="summary">
                    ...
                    <div class="grand-total"><span>Total Amount Payable: </span>NZD $<?=$grand_total ?></div>
                </div>
            </div>
        </section>
